...
1. 保持宿主机端口默认绑定：NeoQBot `127.0.0.1:6688`、NapCat WebUI
   `127.0.0.1:6099`、OneBot HTTP `127.0.0.1:6000`。不要直接映射到 `0.0.0.0` 或公网 IP。
...
- Keep host bindings on loopback: `127.0.0.1:6688`, `127.0.0.1:6099`, and `127.0.0.1:6000`.
